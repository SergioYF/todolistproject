...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FileSaver = __webpack_require__(160);
	...
	var TodosList = React.createClass({
		...
		render: function () {
			...
			return React.createElement('div', null, React.createElement('h1', null, 'TodoList Sergea'), React.createElement(TypeNew, { replace: this.handleReplace, todos: this.state.todolist }), React.createElement(ListTodo, { replace: this.handleReplace, todos: this.state.todolist }), React.createElement(SaveListTodo, { url: this.props.url, todos: this.state.todolist }));
		}
	});
	...
	var Detail = React.createClass({
		...
		render: function () {
			return React.createElement('form', { onSubmit: this.props.saveContent, className: 'form' }, React.createElement('textarea', { rows: '4', cols: '45', type: 'text', ref: 'content', id: 'textarea' }, this.props.detail), React.createElement('input', { type: 'submit', value: '\u4FDD\u5B58', className: 'save' }));
		}
	});
	...
	var TypeNew = React.createClass({
		...
		render: function () {
			return React.createElement('form', { onSubmit: this.addContent, className: 'form' }, React.createElement('input', { type: 'text', ref: 'content', className: 'input' }), React.createElement('input', { type: 'submit', value: '\u6DFB\u52A0', className: 'add' }), React.createElement('div', null, React.createElement('label', null, ' \u622A\u6B62\u65E5\u671F\uFF1A '), React.createElement('input', { type: 'date', ref: 'date', placeholder: 'YYYY-MM-DD', id: 'txtDate' })));
		}
	});
	...
	var SaveListTodo = React.createClass({
		...
		render: function () {
			return React.createElement('form', { onSubmit: this.saveJSON, action: '/todolist/save', method: 'get' }, React.createElement('input', { type: 'submit', value: '\u4FDD\u5B58', className: 'add' }), React.createElement('p', null, ' \u6CE8\uFF1A\u6682\u4E0D\u652F\u6301\u6C49\u5B57\u8F93\u5165 '));
		}
	});
	...
	var ListTodo = React.createClass({
		...
		render: function () {
			return React.createElement('ul', { id: 'todo-list' }, this.props.todos.map(function (todo, i) {
				if (todo.start_date) {
				...
				if (todo.completed === true && todo.click === true) {
					return React.createElement('li', { className: 'content' }, React.createElement('s', null, todo.title), React.createElement('span', { className: 'del', onClick: this.delContent, 'data-index': i }, '\u5220\u9664'), React.createElement('span', { className: 'del', onClick: this.clickTodo, 'data-index': i }, '\u67E5\u770B\u8BE6\u60C5'), React.createElement('div', null, React.createElement(Detail, { detail: todo.detail, saveContent: this.saveDetail }), React.createElement('form', { className: 'form' }, React.createElement('label', null, ' \u5F00\u59CB:', start_date, ' \u622A\u6B62 '), React.createElement('input', { type: 'date', ref: 'date', placeholder: todo.expired_date, id: 'txtDate', size: '10' }), React.createElement('label', null, ' \u4F18\u5148\u7EA7 '), React.createElement('input', { type: 'date', ref: 'priority', placeholder: todo.priority, id: 'priority', size: '2' }))));
				} else if (todo.completed === true && todo.click === false) {
					return React.createElement('li', { className: 'content' }, React.createElement('s', null, todo.title), React.createElement('span', { className: 'del', onClick: this.delContent, 'data-index': i }, '\u5220\u9664'), React.createElement('span', { className: 'del', onClick: this.clickTodo, 'data-index': i }, '\u67E5\u770B\u8BE6\u60C5'));
				} else if (todo.completed === false && todo.click === true) {
					return React.createElement('li', { className: 'content' }, React.createElement('label', null, todo.title), React.createElement('span', { className: 'del', onClick: this.delContent, 'data-index': i }, '\u5220\u9664'), React.createElement('span', { className: 'del', onClick: this.completeContent, 'data-index': i }, '\u5B8C\u6210'), React.createElement('span', { className: 'del', onClick: this.clickTodo, 'data-index': i }, '\u67E5\u770B\u8BE6\u60C5'), React.createElement('div', null, React.createElement(Detail, { detail: todo.detail, saveContent: this.saveAttr }), React.createElement('form', { className: 'form' }, React.createElement('label', null, ' \u5F00\u59CB:', start_date, ' \u622A\u6B62 '), React.createElement('input', { type: 'date', ref: 'date', placeholder: todo.expired_date, id: 'txtDate', size: '10' }), React.createElement('label', null, ' \u4F18\u5148\u7EA7 '), React.createElement('input', { type: 'date', ref: 'priority', placeholder: todo.priority, id: 'priority', size: '2' }))));
				} else {
					return React.createElement('li', { className: 'content' }, React.createElement('label', null, todo.title), React.createElement('span', { className: 'del', onClick: this.delContent, 'data-index': i }, '\u5220\u9664'), React.createElement('span', { className: 'del', onClick: this.completeContent, 'data-index': i }, '\u5B8C\u6210'), React.createElement('span', { className: 'del', onClick: this.clickTodo, 'data-index': i }, '\u67E5\u770B\u8BE6\u60C5'));
				}
			}.bind(this)));
